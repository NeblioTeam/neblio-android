...
//                + " existing key " + io.nebl.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + io.nebl.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != io.nebl.core.coins.nxt.Crypto.rsDecode(io.nebl.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = io.nebl.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = io.nebl.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = io.nebl.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, io.nebl.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(io.nebl.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = io.nebl.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
