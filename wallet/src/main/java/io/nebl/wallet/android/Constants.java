...
import io.nebl.core.coins.NeblioMain;
import io.nebl.core.network.CoinAddress;
import io.nebl.stratumj.ServerAddress;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/NeblioTeam/neblio-android/releases";

    public static final String VERSION_URL = "";
    public static final String SUPPORT_EMAIL = "info@nebl.io";

    // TODO move to resource files
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            new CoinAddress(NeblioMain.get(),       new ServerAddress("electrum.nebl.io", 50001))
                                                    //new ServerAddress("electrum2.nebl.io", 50001))
    );
    ...
    static {
        ...
        COINS_ICONS.put(CoinID.NEBLIO_MAIN.getCoinType(), R.drawable.neblio);

        COINS_BLOCK_EXPLORERS = new HashMap<CoinType, String>();
        COINS_BLOCK_EXPLORERS.put(CoinID.NEBLIO_MAIN.getCoinType(), "http://explorer.nebl.io/tx/%s");
    }

    public static final CoinType DEFAULT_COIN = NeblioMain.get();

    public static final List<CoinType> DEFAULT_COINS = ImmutableList.of((CoinType) NeblioMain.get());
